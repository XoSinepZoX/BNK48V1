			...
			<td colspan="4">
				<div class = "shadowbox">
					<a href="contentmain.php" target="contentblock">
						<img class="banner" src="https://uppic.cc/d/KgmZ" width="100%">
						<img class="banner" src="https://uppic.cc/d/Kgmt" width="100%">
						<img class="banner" src="https://sv1.picz.in.th/images/2019/03/31/tu8e7P.png" width="100%">
					</a>
				</div>
			</td>	
		</tr>
